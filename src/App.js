...
"condition": "New",
"year": "2026",
"desc": "A refined gold-toned timepiece featuring a minimalist square design. This watch combines timeless style with reliable quartz movement, making it a perfect daily accessory for any occasion.",
"descAr": "ساعة أنيقة باللون الذهبي تتميز بتصميم مربع بسيط. تجمع هذه الساعة بين الأناقة الخالدة وحركة الكوارتز الموثوقة، مما يجعلها إكسسواراً يومياً مثالياً لأي مناسبة.",
"features": ["Gold-tone Finish", "Minimalist Dial", "Quartz Precision"],
"featAr": ["طلاء ذهبي", "مينا بسيط", "دقة الكوارتز"],
"img": null,
"exclusive": false,
"hot": false
